...
func (s *service) GetService() *components.Service {
	return util.CreateService("registration", utils.GetLabel("registration"),s.blackduck.Spec.Namespace,  "8443",  "8443", horizonapi.ClusterIPServiceTypeDefault,utils.GetVersionLabel("registration", s.blackduck.Spec.Version))
}

...
func (s *service) GetService() *components.Service {
	return util.CreateService("webserver", utils.GetLabel("webserver"), s.blackduck.Spec.Namespace, "443", "8443", horizonapi.ClusterIPServiceTypeDefault, utils.GetVersionLabel("webserver", s.blackduck.Spec.Version))
}

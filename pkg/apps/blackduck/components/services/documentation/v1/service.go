...
func (s *service) GetService() *components.Service {
	return util.CreateService("documentation", utils.GetLabel("documentation"), s.blackduck.Spec.Namespace, "8443", "8443", horizonapi.ClusterIPServiceTypeDefault, utils.GetVersionLabel("documentation", s.blackduck.Spec.Version))
}

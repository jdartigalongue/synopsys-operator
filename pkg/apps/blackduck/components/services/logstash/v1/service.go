...
func (s *service) GetService() *components.Service {
	return util.CreateService("logstash", utils.GetLabel("webapp-logstash"), s.blackduck.Spec.Namespace, "5044", "5044", horizonapi.ClusterIPServiceTypeDefault, utils.GetVersionLabel("webapp-logstash", s.blackduck.Spec.Version))
}
